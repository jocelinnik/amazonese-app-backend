...
const eventosRoutes = (): Router => {
    ...
    routes.get("/participante/:cpf_participante/favoritos", [verificadorTokenJWT.executar.bind(verificadorTokenJWT)], buscarEventosFavoritosParticipante.executar.bind(buscarEventosFavoritosParticipante));
