...
import { CargaTokenAutenticacaoDTO, TokenAutenticacaoDTO } from "@/aplicacao/dto/token-autenticacao.dto";
import { GerenciadorTokenAutenticacao } from "@/aplicacao/providers/gerenciador-tokens-autenticacao";

type CustomJWTGerenciadorTokenAutenticacaoParams = {
    chave: string;
    sub: string;
 ...
 */
class CustomJWTGerenciadorTokenAutenticacao implements GerenciadorTokenAutenticacao {
     ...
     * JWT.
     */
    public constructor(params: CustomJWTGerenciadorTokenAutenticacaoParams){
...
export { CustomJWTGerenciadorTokenAutenticacao };
