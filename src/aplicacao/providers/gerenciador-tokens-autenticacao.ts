import { TokenAutenticacaoDTO } from "@/aplicacao/dto/token-autenticacao.dto";
import { TokenExpiradoError, TokenInvalidoError } from "@/aplicacao/exceptions/token-autenticacao.exception";
